            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div
                        ...
                        <img src="{{asset('assets/images/Soal.png')}}" alt="سوالات متداول" class="img2">
                    ...
                    <div class="panel-body d-flex flex-column justify-content-center align-items-center col-12">
                        <table class="table text-center" dir="rtl">
                            <thead>
                            <a href="{{route('Admin.Soal.create')}}" class="btn btn-block btn-info">افزودن سوال<i
                            ...
                            @foreach($items as $item)
                                <tr class="text-center">
                                    <td>{{$item -> Question}}</td>
                                    <td>{{$item -> Answer}}</td>
                                    <td><a href="{{ route('Admin.Soal.edit', $item->id) }}" class="btn btn-warning">
                                            <i class="material-icons">edit</i>
                                        </a></td>
                                    <td>
                                        {{ html()->form('DELETE', route('Admin.Soal.destroy', $item->id))->open() }}
