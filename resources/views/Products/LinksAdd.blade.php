                    ...
                    <div class="panel-body">
                        ...
                        <table class="table text-right mt-5 w-100" dir="rtl">
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ html()->select('PName')->open() }}
                                    @if(isset($item))
                                        {{ html()->option($item->PName)->value($item->PName) }}
                                    @endif
                            ...
                            <tr style="border-bottom: 3px dashed #333 !important;">
                                ...
                                <td>
                                    {{ html()->text('date')->class('form-control date1')->attribute('autocomplete="off"') }}
                                    @error('date')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </td>
