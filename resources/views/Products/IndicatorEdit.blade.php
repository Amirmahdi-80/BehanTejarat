            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        @csrf
                        {{ html()->model($item)->form('POST', route('Admin.Indicators.update', $item->id))->open() }}
                        <div class="d-flex flex-column justify-content-center align-items-center w-100">
                            <table class="table text-right w-50" dir="rtl">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{html()->text('Product')->class('form-control')->value($item->Product)->isReadonly()}}
                                    </td>
                                    @error('Tamin')
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if(isset($item))
                                            {{html()->option($item->Tamin)->value($item->Tamin)->selected()}}
                                        @endif
                            ...
                            <table class="table text-right table-borderless" dir="rtl">
                                ...
                                <tr class="text-center">
                                    ...
                                    {{--سلکت--}}
                                    <td scope="col">
                                        {{html()->text('Product1')->class('form-control')->value($item->Product1)->isReadonly()}}
                                    </td>
                                    {{--مقدار شاخص--}}
                                    <td scope="col">
                                    ...
                                    <td scope="col">{{html()->text('Analyse1')->class('form-control')->placeholder('درصد آنالیز')->id('Anz1')->isReadonly()}}</td>
                                    <td scope="col">{{html()->text('Deviation1')->class('form-control')->placeholder('درصد انحراف')->id('Dev1')->isReadonly()}}</td>
                                </tr>
                                @for($i = 2; $i <= 20; $i++)
                                    @if(!$item->{"Product$i"} == "")
                                        <tr class="text-center">
                                            ...
                                            {{--سلکت--}}
                                            <td scope="col">
                                                {{html()->text("Product$i")->class('form-control')->value($item->{"Product$i"})->isReadonly()}}
                                            </td>
                                            {{--مقدار شاخص--}}
                                            <td scope="col">
                                                @foreach($Products as $Product)
                                            ...
                                            <td scope="col">{{html()->text("Analyse$i")->class('form-control')->placeholder('درصد آنالیز')->id("Anz$i")->isReadonly()}}</td>
                                            <td scope="col">{{html()->text("Deviation$i")->class('form-control')->placeholder('درصد انحراف')->id("Dev$i")->isReadonly()}}</td>
                                        </tr>
                                    @endif
                                @endfor
                                <tr class="text-center">
                                    ...
                                    {{--سلکت--}}
                                    <td scope="col">
                                        {{html()->text('TolKol')->class('form-control')->placeholder("مجموع تولید واقعی")->id("TolKol")->isReadonly()}}
                                    </td>
                                    {{--مقدار شاخص--}}
                                    <td scope="col">
                                        -
