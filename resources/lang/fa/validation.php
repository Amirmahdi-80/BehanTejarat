...
return [
    ...
    */
    'attributes' => [
        ...
        "ProductComment"=>"نام محصول",
        "ProductNo"=>"مقدار محصول",
        ...
        "CarName"=>"نام خودرو",
        "CarColor"=>"رنگ خودرو",
        "ExitDistance"=>"کیلومتر خروج",
        "exit1"=>"ساعت خروج اول",
        "car_id"=>"نام خودرو",
        "driver_id"=>"نام راننده",
        "DriverName"=>"نام راننده",
        "MeliCode"=>"کد ملی",
        "Badane"=>"بیمه بدنه",
        "BargSabz"=>"برگه سبز خودرو",
        "CarCard"=>"کارت خودرو",
        "BimeSales"=>"بیمه شخص ثاث",
        "Kilometer"=>"کیلومتر کارکرد",
        "Sort"=>'دسته بندی',
        "Send"=>'ارسال',
        "TaminCode"=>"کد تامین کننده",
        "TaminName"=>"نام تامین کننده",
        "DriverNumber"=>"شماره تلفن راننده",
        "VahedName"=>"نام واحد",
        "VahedName2"=>"نام مخفف واحد",
        "SortCode"=>"کد دسته بندی",
        "SortName"=>"نام دسته بندی",
        "Group"=>"گروه هزینه",
        'SlideName'=>'نام اسلایدر',
        'OrderDot'=>'نقطه سفارش',
        'enterPrice'=>'قیمت ورودی',
        'Count'=>'مقدار ورودی',
        'TotalPrice'=>'قیمت کل'
    ],
];
